...
<div class="container-fluid p-4">
    <div class="card p-3">
        <div class="card-header">
            <h1>{{ __('app.supplier_returns.create_title') }}</h1>
        </div>
        ...
        <form action="{{ route('supplier-returns.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">{{ __('app.supplier_returns.available_quantity') }} <span id="available-quantity">0</span></small>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="notes" id="notes" class="form-control" rows="3"
                                  placeholder="{{ __('app.supplier_returns.notes_placeholder') }}">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <a href="{{ route('supplier-returns.index') }}" class="btn btn-secondary">{{ __('app.common.cancel') }}</a>
            </div>
        </form>
    </div>
</div>
