...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{ __('app.brands.edit') }}</h3>
        ...
        <div class="content-header-right col-md-6 col-12 d-flex justify-content-end align-items-center">
            <a href="{{ route('brands.index') }}" class="btn btn-secondary round px-3 shadow-sm">
                            ...
                            <form action="{{ route('brands.update', $brand->id) }}" method="POST">
                                ...
                                <div class="form-actions text-center mt-4">
                                    <button type="submit" class="btn btn-warning round px-4 shadow text-white">
                                        <i class="la la-save"></i> {{ __('app.brands.update') }}
                                    </button>
