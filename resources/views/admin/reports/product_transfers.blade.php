...
<div class="container-fluid card shadow-lg p-5 bg-light">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span class="badge bg-info text-dark ms-3" data-bs-toggle="tooltip" title="يتم عرض عمليات النقل التي تحتوي على كمية منقولة فقط (1 أو أكثر)">
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white shadow">
                    <div class="card-body text-center">
                        ...
                        <h3>{{ number_format($transfers->avg(function($t) { return $t->new_selling_price - $t->new_cost_price; }), 2) }} ج.م</h3>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-dark shadow">
                    <div class="card-body text-center">
                        ...
                        <h3>{{ number_format($transfers->sum(function($t) { return ($t->new_selling_price - $t->new_cost_price) * $t->transferred_quantity; }), 2) }} ج.م</h3>
