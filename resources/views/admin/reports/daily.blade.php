...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="font-weight-bold text-white mb-1">{{ __('app.reports.title_daily') }}</h2>
                                ...
                                <td>
                                    <ul class="list-unstyled mb-0">
                                        @foreach($invoice->sales as $sale)
                                            <li><i class="la la-check text-success mr-1"></i>{{ $sale->product->name }} ({{ $sale->quantity }}) - {{ $sale->product->selling_price }}</li>
                                        @endforeach
                                    </ul>
                                </td>
                            </tr>
