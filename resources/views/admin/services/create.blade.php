...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">{{ __('app.sidebar.add_service') ?? 'إضافة خدمة جديدة' }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    <label for="color" class="text-bold-600">{{ __('app.products.barcode') }} <small class="text-muted">({{ __('app.products.optional') ?? 'اختياري' }})</small></label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control round border-primary" id="color" name="color" 
                                            value="{{ old('color') }}" placeholder="{{ __('app.products.search_placeholder') }}">
                                    </div>
                                </div>
                            </div>
