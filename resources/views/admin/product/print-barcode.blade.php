...
@section('content')
    ...
    <div class="container">
        ...
        <button class="btn btn-info" onclick="window.print()"> {{ __('app.products.print_barcode') }} </button>
        <a href="{{ route('products.index') }}" class="btn btn-secondary"> {{ __('app.products.back_to_products') }} </a>
    </div>
@endsection