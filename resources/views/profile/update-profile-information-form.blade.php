<x-form-section submit="updateProfileInformation">
    <x-slot name="title">
        {{ __('app.profile.update_info') }}
    </x-slot>

    <x-slot name="description">
        {{ __('app.profile.update_info_desc') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="name" value="{{ __('app.profile.name') }}" />
        ...
        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="email" value="{{ __('app.profile.email') }}" />
