...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="row animate-fade-in-up">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="premium-card h-100" style="--card-accent: var(--p-amber);">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="premium-card h-100" style="--card-accent: var(--p-rose);">
                    <div class="card-icon-wrapper" style="background: rgba(225, 29, 72, 0.1); color: var(--p-rose);">
                        <i class="la la-box"></i>
                    </div>
            ...
            <div class="col-lg-8">
                <div class="premium-card mb-4">
                    <div class="d-flex align-items-center mb-4">
                        <div class="bg-glass p-3 rounded-circle mr-3 shadow-glow">
                            <i class="la la-search text-gradient-premium h4 mb-0"></i>
                        </div>
                        <h5 class="font-weight-bold mb-0 text-white">{{ __('app.platform.vendor_search') }}</h5>
                    </div>
                ...
                <div class="premium-card p-0 overflow-hidden mb-4">
                    <div class="p-4 d-flex justify-content-between align-items-center border-bottom" style="border-color: rgba(255,255,255,0.05) !important;">
                        <h5 class="font-weight-bold mb-0 text-white">{{ __('app.platform.recent_vendors') }}</h5>
                        <a href="{{ route('super-admin.vendors.index') }}" class="btn btn-sm btn-white px-3">View All</a>
                    </div>
                            ...
                            <tbody>
                                @foreach($recentVendors as $vendor)
                                    <tr class="hover-bg-glass">
                                        <td class="px-4 py-3 font-weight-bold text-white">{{ $vendor->business_name }}</td>
                                        <td class="py-3 text-muted">{{ $vendor->owner->name }}</td>
                                        <td class="py-3 text-center">
                                            <span
                                                class="badge badge-pill {{ $vendor->status === 'active' ? 'badge-success' : 'badge-danger' }} px-3">
            ...
            <div class="col-lg-4">
                <div class="premium-card mb-4" style="--card-accent: var(--p-indigo);">
                    <div class="text-center mb-4">
                        <div class="bg-glass p-3 rounded-circle d-inline-block shadow-glow">
                            <i class="la la-crown text-gradient-premium font-large-1"></i>
                        </div>
                        <h5 class="font-weight-bold mt-3 mb-0 text-white">{{ __('app.platform.top_performing_vendors') }}
                        </h5>
                    </div>
                    <div class="mt-4">
                        @foreach($topVendors as $vendor)
                            <div class="d-flex align-items-center mb-4 p-2 rounded-lg transition-all hover-bg-glass">
                                <div class="bg-glass p-3 rounded-xl mr-3 shadow-sm" style="width: 50px; text-align: center;">
